...
public class AgenteManager {
    ...
    public void mostrarEstadisticas() {
        ...
        System.out.println("Total de agentes registrados: " + numAgentes);
    }
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. numero de agentes registrados");
            System.out.println("4. Salir a menu principal");
